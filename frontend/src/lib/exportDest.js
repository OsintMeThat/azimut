/**
 * Export destinations: where the notes PDFs, the media copies, the proof PNGs, the
 * analysis plates and the sheet CSVs land, and the folder browser that lets the
 * analyst say so.
 *
...
export const KINDS = ['notes', 'media', 'proofs', 'views', 'sheets'];
